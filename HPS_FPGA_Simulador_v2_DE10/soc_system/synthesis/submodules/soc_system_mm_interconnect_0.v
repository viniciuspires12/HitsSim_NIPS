...
module soc_system_mm_interconnect_0 (
	...
	wire  [100:0] occ_ram_s1_agent_rf_source_data;                                            // occ_ram_s1_agent:rf_source_data -> occ_ram_s1_agent_rsp_fifo:in_data
	...
	wire  [100:0] occ_ram_s1_agent_rsp_fifo_out_data;                                         // occ_ram_s1_agent_rsp_fifo:out_data -> occ_ram_s1_agent:rf_sink_data
	...
	wire  [126:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	...
	wire  [127:0] ilc_avalon_slave_agent_rf_source_data;                                      // ILC_avalon_slave_agent:rf_source_data -> ILC_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [127:0] ilc_avalon_slave_agent_rsp_fifo_out_data;                                   // ILC_avalon_slave_agent_rsp_fifo:out_data -> ILC_avalon_slave_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                      // cmd_mux_003:src_valid -> ILC_avalon_slave_agent:cp_valid
	wire  [126:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> ILC_avalon_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // ILC_avalon_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> ILC_avalon_slave_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                              // cmd_mux_003:src_startofpacket -> ILC_avalon_slave_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                // cmd_mux_003:src_endofpacket -> ILC_avalon_slave_agent:cp_endofpacket
	...
	wire  [126:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> sysid_qsys_control_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                      // sysid_qsys_control_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire  [126:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> button_pio_s1_agent:cp_data
	...
	wire  [126:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> dipsw_pio_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                      // dipsw_pio_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                    // cmd_mux_006:src_channel -> dipsw_pio_s1_agent:cp_channel
	...
	wire  [126:0] led_pio_s1_agent_rp_data;                                                   // led_pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire   [99:0] occ_ram_s1_agent_rp_data;                                                   // occ_ram_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [126:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                  // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [126:0] ilc_avalon_slave_agent_rp_data;                                             // ILC_avalon_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [126:0] dipsw_pio_s1_agent_rp_data;                                                 // dipsw_pio_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [126:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> led_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                          // led_pio_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [6:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> led_pio_s1_burst_adapter:sink0_channel
	...
	wire   [99:0] occ_ram_s1_burst_adapter_source0_data;                                      // occ_ram_s1_burst_adapter:source0_data -> occ_ram_s1_agent:cp_data
	wire          occ_ram_s1_burst_adapter_source0_ready;                                     // occ_ram_s1_agent:cp_ready -> occ_ram_s1_burst_adapter:source0_ready
	wire    [6:0] occ_ram_s1_burst_adapter_source0_channel;                                   // occ_ram_s1_burst_adapter:source0_channel -> occ_ram_s1_agent:cp_channel
	...
	wire  [126:0] cmd_demux_002_src1_data;                                                    // cmd_demux_002:src1_data -> cmd_mux_002:sink0_data
	wire          cmd_demux_002_src1_ready;                                                   // cmd_mux_002:sink0_ready -> cmd_demux_002:src1_ready
	wire    [6:0] cmd_demux_002_src1_channel;                                                 // cmd_demux_002:src1_channel -> cmd_mux_002:sink0_channel
	...
	wire  [126:0] cmd_demux_002_src2_data;                                                    // cmd_demux_002:src2_data -> cmd_mux_003:sink0_data
	wire          cmd_demux_002_src2_ready;                                                   // cmd_mux_003:sink0_ready -> cmd_demux_002:src2_ready
	wire    [6:0] cmd_demux_002_src2_channel;                                                 // cmd_demux_002:src2_channel -> cmd_mux_003:sink0_channel
	...
	wire  [126:0] cmd_demux_002_src3_data;                                                    // cmd_demux_002:src3_data -> cmd_mux_004:sink0_data
	wire          cmd_demux_002_src3_ready;                                                   // cmd_mux_004:sink0_ready -> cmd_demux_002:src3_ready
	wire    [6:0] cmd_demux_002_src3_channel;                                                 // cmd_demux_002:src3_channel -> cmd_mux_004:sink0_channel
	...
	wire  [126:0] cmd_demux_002_src4_data;                                                    // cmd_demux_002:src4_data -> cmd_mux_005:sink0_data
	wire          cmd_demux_002_src4_ready;                                                   // cmd_mux_005:sink0_ready -> cmd_demux_002:src4_ready
	wire    [6:0] cmd_demux_002_src4_channel;                                                 // cmd_demux_002:src4_channel -> cmd_mux_005:sink0_channel
	...
	wire  [126:0] rsp_demux_002_src0_data;                                                    // rsp_demux_002:src0_data -> rsp_mux_002:sink1_data
	wire          rsp_demux_002_src0_ready;                                                   // rsp_mux_002:sink1_ready -> rsp_demux_002:src0_ready
	wire    [6:0] rsp_demux_002_src0_channel;                                                 // rsp_demux_002:src0_channel -> rsp_mux_002:sink1_channel
	...
	wire  [126:0] rsp_demux_003_src0_data;                                                    // rsp_demux_003:src0_data -> rsp_mux_002:sink2_data
	wire          rsp_demux_003_src0_ready;                                                   // rsp_mux_002:sink2_ready -> rsp_demux_003:src0_ready
	wire    [6:0] rsp_demux_003_src0_channel;                                                 // rsp_demux_003:src0_channel -> rsp_mux_002:sink2_channel
	...
	wire  [126:0] rsp_demux_004_src0_data;                                                    // rsp_demux_004:src0_data -> rsp_mux_002:sink3_data
	wire          rsp_demux_004_src0_ready;                                                   // rsp_mux_002:sink3_ready -> rsp_demux_004:src0_ready
	wire    [6:0] rsp_demux_004_src0_channel;                                                 // rsp_demux_004:src0_channel -> rsp_mux_002:sink3_channel
	...
	wire  [126:0] rsp_demux_005_src0_data;                                                    // rsp_demux_005:src0_data -> rsp_mux_002:sink4_data
	wire          rsp_demux_005_src0_ready;                                                   // rsp_mux_002:sink4_ready -> rsp_demux_005:src0_ready
	wire    [6:0] rsp_demux_005_src0_channel;                                                 // rsp_demux_005:src0_channel -> rsp_mux_002:sink4_channel
	...
	wire   [99:0] router_004_src_data;                                                        // router_004:src_data -> occ_ram_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                       // occ_ram_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [6:0] router_004_src_channel;                                                     // router_004:src_channel -> occ_ram_s1_rsp_width_adapter:in_channel
	...
	wire  [126:0] occ_ram_s1_rsp_width_adapter_src_data;                                      // occ_ram_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          occ_ram_s1_rsp_width_adapter_src_ready;                                     // rsp_demux_001:sink_ready -> occ_ram_s1_rsp_width_adapter:out_ready
	wire    [6:0] occ_ram_s1_rsp_width_adapter_src_channel;                                   // occ_ram_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [126:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> occ_ram_s1_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                                      // occ_ram_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> occ_ram_s1_cmd_width_adapter:in_channel
	...
	wire   [99:0] occ_ram_s1_cmd_width_adapter_src_data;                                      // occ_ram_s1_cmd_width_adapter:out_data -> occ_ram_s1_burst_adapter:sink0_data
	wire          occ_ram_s1_cmd_width_adapter_src_ready;                                     // occ_ram_s1_burst_adapter:sink0_ready -> occ_ram_s1_cmd_width_adapter:out_ready
	wire    [6:0] occ_ram_s1_cmd_width_adapter_src_channel;                                   // occ_ram_s1_cmd_width_adapter:out_channel -> occ_ram_s1_burst_adapter:sink0_channel
	...
	wire          ilc_avalon_slave_agent_rdata_fifo_out_valid;                                // ILC_avalon_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] ilc_avalon_slave_agent_rdata_fifo_out_data;                                 // ILC_avalon_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          ilc_avalon_slave_agent_rdata_fifo_out_ready;                                // avalon_st_adapter_003:in_0_ready -> ILC_avalon_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                                          // avalon_st_adapter_003:out_0_valid -> ILC_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                           // avalon_st_adapter_003:out_0_data -> ILC_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                          // ILC_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                          // avalon_st_adapter_003:out_0_error -> ILC_avalon_slave_agent:rdata_fifo_sink_error
